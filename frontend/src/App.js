  ...
  useEffect(() => {
    ...
    async function getStripeApiKey() {
      try {
        ...
        setStripePromise(loadStripe(data.stripeApiKey)); // Set stripePromise only once
      } catch (error) {
    ...
    <Router>
      ...
      <Routes>
        ...
        {stripePromise ? (
          ...
          <Route exact path="/process/payment" element={<div>Loading Stripe...</div>} />
        )}
        ...
        <Route path='*' element={
          window.location.pathname === "/process/payment" ? null : <><NotFound/><Footer/></>
        } />
      </Routes>
    </Router>
  );
